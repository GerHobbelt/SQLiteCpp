...
public:
	...
	// -------------------------------------------------------------------------------
	explicit Database() {};
	int init_v2(const std::string& db_file, std::string& str_err, const int flag = SQLite::OPEN_READONLY, const int busy_time_out = 0,  const std::string& vfs = "");
	int init(const std::string& db_file, std::string& str_err, const int flag = SQLite::OPEN_READONLY);
	// -------------------------------------------------------------------------------
